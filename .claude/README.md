...
### 4. MCP 集成 (`mcp-integration/`) ⭐ 新增

MCP Server 与 Open API 集成的可复用代码模板和最佳实践。
...
- **v1.1.0** (2026-02-22): 新增 MCP 集成技能，包含 Open API 签名认证、响应处理、文件下载等可复用模板
- **v1.0.0** (2026-02-21): 初始版本，包含 3 个核心技能（API 测试、代码审查、文档生成）

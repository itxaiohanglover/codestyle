...
public class MockDataGenerator {
    ...
    private static final String[] CHINESE_NAMES = {"用户管理模板", "权限认证中心", "配置管理模板", "日志分析系统", "智能推荐模型", "大数据计算模板",
        "微服务基础框架", "分布式任务调度"};

    private static final String[] ENGLISH_NAMES = {"UserManager", "AuthCenter", "ConfigCenter", "LogAnalyzer",
        "RecommendationEngine", "BigDataSuite", "MicroServiceKit", "TaskScheduler"};

    private static final String[] DESCRIPTIONS = {"这是一个用于处理用户相关逻辑的核心模板", "适用于权限认证与统一登录的基础模板", "提供配置中心核心实现的模板",
        "日志采集与分析结构示例模板", "用于智能推荐与模型训练的模板", "大数据聚合分析任务的基础模板", "微服务架构基础工程模板", "面向分布式任务调度场景的模板"};

    private static final String[] TAGS = {"Java", "Spring Boot", "微服务", "Cloud", "AI", "Data", "Compute", "DevOps"};

    private static final String[] AVATARS = {"https://example.com/avatar1.png", "https://example.com/avatar2.png",
        "https://example.com/avatar3.png", "https://example.com/avatar4.png"};

    private static final String[] MEMBER_NAMES = {"Alice", "Bob", "Charlie", "David", "Eve", "Frank", "Grace", "Helen"};

    private static final String[] MEMBER_AVATARS = {"https://example.com/user1.png", "https://example.com/user2.png",
        "https://example.com/user3.png", "https://example.com/user4.png"};

    private static final String[] VERSIONS = {"1.0.0", "1.1.0", "2.0.0", "2.1.3", "3.0.0"};

    private static final String[] CATEGORIES = {"后端开发", "大数据", "人工智能", "微服务", "权限系统", "前端工程"};

...
public enum StorageTypeEnum implements BaseEnum<Integer> {
    ...
    public static StorageTypeEnum fromValue(Integer value) {
        if (value == null) {
            return null;
        }
    ...
    @JsonCreator
    public static StorageTypeEnum fromJson(Number value) {
        return fromValue(value == null ? null : value.intValue());
    }
}

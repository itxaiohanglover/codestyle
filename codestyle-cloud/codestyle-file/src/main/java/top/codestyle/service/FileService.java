...
import top.codestyle.base.service.BaseService;
...
public interface FileService extends BaseService<FileResp, FileResp, FileQuery, FileReq>, IService<FileDO> {
    ...
    default String getDefaultParentPath() {
        ...
        return StringConstants.SLASH + today.getYear() + StringConstants.SLASH + today.getMonthValue() + StringConstants.SLASH + today
